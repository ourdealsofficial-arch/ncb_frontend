...
export const components = {
  button: {
    primary:
      "px-6 py-2.5 bg-[#FF6B35] text-white rounded-lg hover:bg-[#E55A2B] font-medium transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed",
    secondary:
      "px-6 py-2.5 bg-white text-[#FF6B35] border-2 border-[#FF6B35] rounded-lg hover:bg-orange-50 font-medium transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed",
    danger:
  ...
  input:
    "w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF6B35] focus:border-transparent transition-all duration-200 disabled:bg-gray-100 disabled:cursor-not-allowed",
